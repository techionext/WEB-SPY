...
export const schemaCreateOffer = z.object({
  title: z
...
export type SchemaCreateOfferInput = z.input<typeof schemaCreateOffer>;
export type SchemaCreateOfferOutput = z.output<typeof schemaCreateOffer>;
